...
public class MusicaController {
    ...
    @PutMapping("/salvar")
    public ModelAndView atualizar(@PathVariable("playlistId") long playlistId, @Valid @ModelAttribute("musica") Musica musica, BindingResult result, RedirectAttributes attr){
